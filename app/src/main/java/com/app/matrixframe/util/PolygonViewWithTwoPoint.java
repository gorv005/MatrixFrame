package com.app.matrixframe.util;
 ...
 */
public class PolygonViewWithTwoPoint extends FrameLayout {
    ...
    public PolygonViewWithTwoPoint(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public PolygonViewWithTwoPoint(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public PolygonViewWithTwoPoint(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        pointer3.setVisibility(GONE);
        pointer4.setVisibility(GONE);
    ...
    private void setPointsCoordinates(Map<Integer, PointF> pointFMap) {
               ...
               double x=pointFMap.get(0).x;
        double y=pointFMap.get(0).y;
        double x1=pointFMap.get(1).x;
        double y1=pointFMap.get(1).y;
