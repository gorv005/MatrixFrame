    ...
    public void openCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Uri tempFileUri = FileProvider.getUriForFile(getActivity().getApplicationContext(),
                    "com.app.matrixframe.provider", // As defined in Manifest
                    file);
            ...
            try {
                switch (requestCode) {
                    case ScanConstants.START_CAMERA_REQUEST_CODE:
                        SharedPreference.getInstance(getActivity()).setBoolean(ScanConstants.CAMERA,true);
                        bitmap = getBitmap(fileUri);
                        break;

                    case ScanConstants.PICKFILE_REQUEST_CODE:
                        SharedPreference.getInstance(getActivity()).setBoolean(ScanConstants.CAMERA,false);
